...
## Task_2
Создай программу, которая будет принимать на вход string и на выход отдавать string без лишних пробелов.text = "   Это           является       примером   текста с    лишними          пробелами        .   "
